    ...
    return (
        ...
        <section className="flex min-h-screen flex-col items-center justify-center text-gray-600 body-font">
            ...
            <div className="lg:max-w-lg  md:w-1/2 w-5/6 mb-10 md:mb-0">
                ...
                <p className="mb-8 leading-relaxed">Who has been nearing completion of my Bachelor of Computer and Information Science with Software development and Data Science @ Auckland University of Technology</p>
